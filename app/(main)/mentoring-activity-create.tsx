...
const styles = StyleSheet.create({
  ...
  divider: { height: 1, backgroundColor: Colors.backgroundSecondary },
  ...
  addPhotoBtn: { width: THUMB, height: THUMB, borderRadius: Radius.md, borderWidth: 1.5, borderColor: Colors.border, borderStyle: "dashed", alignItems: "center", justifyContent: "center", marginRight: Spacing[2], gap: 4, backgroundColor: Colors.backgroundSecondary },
